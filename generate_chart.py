...
AGENTS = [
    ...
    },
    {
        ...
        "total_query_url": "https://github.com/search?q=is:pr+(author:devin-ai-integration[bot]+OR+head:devin+OR+head:devin/)&type=pullrequests",
        "merged_query_url": "https://github.com/search?q=is:pr+(author:devin-ai-integration[bot]+OR+head:devin+OR+head:devin/)+is:merged&type=pullrequests",
        "ready_query_url": "https://github.com/search?q=is:pr+(author:devin-ai-integration[bot]+OR+head:devin+OR+head:devin/)+-is:draft&type=pullrequests",
        "draft_query_url": "https://github.com/search?q=is:pr+(author:devin-ai-integration[bot]+OR+head:devin+OR+head:devin/)+is:draft&type=pullrequests",
    },
    {
        "key": "codegen",
        "display": "Codegen",
